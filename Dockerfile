...
COPY src /usr/src/geo_dprkp/
WORKDIR /usr/src/geo_dprkp
...
RUN chmod +x /usr/src/geo_dprkp/tasks.py \
    && chmod +x /usr/src/geo_dprkp/entrypoint.sh
...
# ENTRYPOINT /usr/src/geo_dprkp/entrypoint.sh
